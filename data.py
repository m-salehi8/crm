...
# =========================
DEDUCTION_TYPES = {
    "tak": DeductionType.objects.get(code="tak"),
    "vam": DeductionType.objects.get(code="vam"),
    "san": DeductionType.objects.get(code="san"),
    "digipay": DeductionType.objects.get(code="digipay"),
    "mashhad": DeductionType.objects.get(code="mashhad"),
    "food": DeductionType.objects.get(code="food"),
}
